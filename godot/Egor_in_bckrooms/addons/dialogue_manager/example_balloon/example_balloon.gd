...
@onready var balloon = $Background
@onready var margin: MarginContainer = $Background/MarginContainer
@onready var character_label: RichTextLabel = $Background/MarginContainer/VBoxContainer/Speaker
@onready var dialogue_label = $Background/MarginContainer/VBoxContainer/LabelText
@onready var responses_menu: VBoxContainer = $Background/MarginContainer/VBoxContainer/ResponseTemplate
